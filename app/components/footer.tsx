...
export default function Footer (){
    ...
    return(
        <footer className="bg-[#b80c09] sticky bottom-0">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-8">
      <Image src={black} alt='' width={50} height={50}></Image>
        ...
        <div className="col-span-2">
          <div>
            ...
            <p className="mt-4 text-gray-500">
              Enjoy our latest news, updates, and vouchers. Limited time offers are always sent to newsletter subscribers. Stay tuned!
            </p>
          </div>
        </div>
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">
          &copy; 2023. Poppy's Ice Cream. All rights reserved.
        </p>
